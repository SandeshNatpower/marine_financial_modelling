...
# Assume these constants and helper function (create_input_group) are defined elsewhere:
# PRIMARY_COLOR, TEXT_COLOR, DEFAULT_VESSEL, DEFAULT_REPORTING_YEAR, DEFAULT_MAIN_ENGINE_POWER,
# DEFAULT_MAIN_FUEL_TYPE, FUEL_OPTIONS, DEFAULT_MAIN_ENGINE_SPEED, DEFAULT_AUX_ENGINE_POWER,
# DEFAULT_AUX_FUEL_TYPE, DEFAULT_AUX_ENGINE_SPEED, DEFAULT_SAILING_DAYS, DEFAULT_WORKING_DAYS,
# DEFAULT_IDLE_DAYS, DEFAULT_SHORE_DAYS, DEFAULT_SHORE_PORT, DEFAULT_SHORE_ENABLE, DEFAULT_ENGINE_MAINT_COST,
# DEFAULT_SPARES_COST, DEFAULT_FUELEU_CURRENT_PENALTY, DEFAULT_FUTURE_MAIN_FUEL_TYPE,
# DEFAULT_FUTURE_AUX_FUEL_TYPE, DEFAULT_FUELEU_FUTURE_PENALTY, DEFAULT_BIOFUELS_SPARES_COST,
# DEFAULT_SHORE_MAINT_COST, DEFAULT_SHORE_SPARES_COST, DEFAULT_PARASITIC_LOAD, DEFAULT_BIOFUELS_BLEND,
# DEFAULT_INFLATION_RATE, DEFAULT_NPV_RATE, DEFAULT_CAPEX
# and create_input_group as defined (using parameter name 'id' and 'value').
